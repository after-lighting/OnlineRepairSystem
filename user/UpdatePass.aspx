<%@ page language="C#" autoeventwireup="true" inherits="user_UpdatePass, App_Web_3bt5r4t4" enableEventValidation="false" %>


<%@ Register Src="~/user/MyHeader.ascx" TagName="MyHeader" TagPrefix="uc1" %>
<%@ Register Src="~/user/MyFooter.ascx" TagPrefix="uc1" TagName="MyFooter" %>
...
<body>
    ...
    <div class="wrapper p-top-0">
         <uc1:MyHeader ID="MainHeader1" runat="server" />
                 ...
                 <div class="col-xs-12">
                     <div class="panel">
                         ...
                         <div class="form-group ">
                             ...
                             <br />
                             <asp:TextBox ID="txtPass" runat="server" TextMode="Password" CssClass="form-control form_datetime"
                                 placeholder="填写登陆密码" MaxLength="255"></asp:TextBox>
                         </div>
                         <div class="form-group ">
                             <label for="txtn_content">
                                 新用户名
                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ForeColor="Red"
                                     ErrorMessage="必填" ControlToValidate="txtNewUser"></asp:RequiredFieldValidator><asp:RegularExpressionValidator
                                         ID="revu_user" ControlToValidate="txtNewUser" ValidationExpression="^[a-zA-Z0-9_]{6,20}$"
                         ...
                         <div class=" form-group">
                             <asp:Button ID="btnSubmit" CssClass="btn btn-primary" runat="server" Text="保存修改"
