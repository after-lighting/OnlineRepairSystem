<%@ page language="C#" autoeventwireup="true" inherits="sysadmin_N25175_User_RepairUserEdit, App_Web_e3ngxtzn" enableEventValidation="false" %>
            ...
            <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label for="inputPassword3" class="col-sm-2 control-label">
                            密码：</label>
                        <div class="col-sm-7">
                            <asp:TextBox ID="txtu_pass" runat="server" CssClass="form-control" MaxLength="25"  TextMode="Password"></asp:TextBox>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <asp:Button ID="btn_Submit" CssClass="btn btn-default btn-primary" runat="server"
                                Text="保存编辑" OnClick="btnSubmit_Click" />
                        </div>
                    </div>
                    </form>
            </div>
