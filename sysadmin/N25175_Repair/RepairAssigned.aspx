<%@ page language="C#" autoeventwireup="true" inherits="sysadmin_RepairAssigned, App_Web_ju4faccj" enableEventValidation="false" %>
...
<div class="wrapper preload">
    ...
    <div class="container" style='margin-top: 55px'>
        <ul class="breadcrumb">
            ...
            <li><a href="/sysadmin/N25175_Repair/RepairList.aspx?state=-1">未指派申请</a> </li>
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">指派维修负责人</h3>
                    </div>
                        ...
                        <form class="form-horizontal" role="form" runat="server">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    ...
                                    <asp:Button ID="btnSubmit" CssClass="btn btn-primary " runat="server" Text="确定指派" OnClick="btnSubmit_Click" />
