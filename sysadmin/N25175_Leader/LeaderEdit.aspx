<%@ page language="C#" autoeventwireup="true" inherits="sysadmin_LeaderEdit, App_Web_tpbbsudx" enableEventValidation="false" %>
  ...
  <div class="wrapper preload">
    ...
    <div class="container" style='margin-top: 55px'>
        ...
        <ul class="breadcrumb">
            ...
            <li class="active">编辑维修负责人
            </li>
        </ul>

        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">编辑维修负责人</h3>
            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <label class="radio-inline">
                                <asp:RadioButton ID="rbNan" GroupName="sex" runat="server" Checked="true" />
                                男
                            </label>
                            <label class="radio-inline">
                                <asp:RadioButton ID="rbNv" GroupName="sex" runat="server" />
                                女
                            </label>
